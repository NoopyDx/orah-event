...
function InfoCard({ info, index }) {
  ...
  return (
    <motion.div
      ...
      className="p-6 rounded-2xl border border-accent-gold/8 bg-bg-secondary/50 hover:border-accent-gold/20 transition-all duration-500"
    >
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="font-accent text-sm uppercase tracking-[0.15em] text-accent-gold mb-2">
            {info.title}
          </h3>
